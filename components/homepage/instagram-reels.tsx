...
// Hardcoded list of Instagram reels from @tathastukeepsakes
// Thumbnails use placeholder SVGs — replace with actual reel screenshots when available
const REELS: Reel[] = [
  { id: '1', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-1.svg' },
  { id: '2', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-2.svg' },
  { id: '3', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-3.svg' },
  { id: '4', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-4.svg' },
  { id: '5', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-5.svg' },
  { id: '6', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-6.svg' },
  { id: '7', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-7.svg' },
  { id: '8', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-8.svg' },
  { id: '9', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-9.svg' },
  { id: '10', url: 'https://www.instagram.com/tathastukeepsakes/', thumbnail: '/images/reels/reel-10.svg' },
]
    ...
    <section className="py-16 sm:py-20 bg-gradient-to-b from-gray-50 to-white" aria-label="Instagram Reels">
      <div className="container-page">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <Link
            href="https://www.instagram.com/tathastukeepsakes/"
            target="_blank"
