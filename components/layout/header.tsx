...
const navItems: NavItem[] = [
  { href: '/', label: 'Home' },
  { href: '/products?category=lamps', label: 'Home Decor', badge: 'new' },
      ...
      <div className="container-page">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            {/* Wishlist */}
            <button
              className="hidden sm:flex p-2 text-muted hover:text-brand transition-colors rounded-md hover:bg-surface"
              aria-label="Wishlist"
          ...
          <ul className="container-page py-3 flex flex-col gap-0.5">
            ...
            <li>
              ...
              >
                ...
                Cart{itemCount > 0 && <span className="ml-auto bg-brand text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">{itemCount}</span>}
              </Link>
            </li>
          </ul>
        </nav>
