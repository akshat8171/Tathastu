...
function CustomizePageInner() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* How it works (CV-03: clearer step labels) */}
      <section className="py-20 px-4 bg-surface">
        <div className="container-page">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-ink text-3xl sm:text-4xl mb-3">How Tathastu Lab Works</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div key={s.step} className="relative text-center">
                ...
                <div className="font-display font-extrabold text-brand/30 text-xl mb-1">{s.step}</div>
